...
{
    public class AllOkrDashboardOkrKRResponse
    {
        ...
        public List<AllOkrDashboardKeyResponse> MyGoalsDetails { get; set; }
        public List<TeamOkrRequest> TeamOkrRequests { get; set; }
        public LinkedObjectiveResponse LinkedObjective { get; set; }
        public bool IsAssigned { get; set; }
        public bool IsAligned { get; set; }
        public bool IsCoach { get; set; }
        public bool IsVirtualAlignment { get; set; }
        public int VirtualAlignmentCount { get; set; }
